...
#pragma mark --把字典 或者数组转换为json字符串
+(NSString *)jsonString:(id)arrayAndDiction{
    NSString * jsonStr;
    NSData *data=[NSJSONSerialization dataWithJSONObject:arrayAndDiction options:NSJSONWritingPrettyPrinted error:nil];

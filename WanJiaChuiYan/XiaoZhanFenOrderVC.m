...
@interface XiaoZhanFenOrderVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation XiaoZhanFenOrderVC
...
-(void)internetData{
    ...
    [Engine WanJiaChuFangChuFangFensuccess:^(NSDictionary *dic) {
        NSString * code =[NSString stringWithFormat:@"%@",[dic objectForKey:@"code"]];
        
        if ([code isEqualToString:@"1"]) {
            NSDictionary * contentDic =[dic objectForKey:@"content"];
            if ([[contentDic objectForKey:@"allStationOrderInfo"] count]==0||[contentDic objectForKey:@"allStationOrderInfo"]==[NSNull null]) {
            ...
            [_dateArray addObject:[contentDic objectForKey:@"orderDate"]];
             ...
             [LCProgressHUD hide];
            NSArray * array =[contentDic objectForKey:@"allStationOrderInfo"];
            for (NSDictionary * dicc  in array)
            {
                ChuFangOrderModel * model =[[ChuFangOrderModel alloc]initWithChuFangDic:dicc];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ChuFangDingDanTableViewCell * cell =[ChuFangDingDanTableViewCell cellWithTableView:tableView CellID:cellid indexp:indexPath];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     return [_tableView cellHeightForIndexPath:indexPath model:_dataArray[indexPath.row]keyPath:@"model" cellClass:[ChuFangDingDanTableViewCell class] contentViewWidth:[self  cellContentViewWith]];
}
